        ...
        theme: ThemeData(
          tabBarTheme: TabBarThemeData(
            ...
            indicator: const BoxDecoration(
              border: Border(bottom: BorderSide(color: Color.fromRGBO(30, 60, 87, 1), width: 2)),
            ),
          ...
          child: Column(
            ...
            children: [
              Directionality(
                ...
                child: Text('Pinput Examples', style: GoogleFonts.poppins(fontSize: 24, fontWeight: FontWeight.w700)),
              ),
              Flexible(
                child: Container(
                  width: 500,
                  ...
                  decoration: BoxDecoration(border: Border.all(width: 15), borderRadius: BorderRadius.circular(20)),
                  child: app,
                ),
              ),
            ],
