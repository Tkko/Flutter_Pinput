...
class Pinput extends StatefulWidget {
  const Pinput({
    ...
    this.initialValue = _defaultContextMenuBuilder,
    Key? key,
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty<Widget?>('separator', separator, defaultValue: PinputConstants._defaultSeparator));
    ...
    properties.add(DiagnosticsProperty<Duration>('animationDuration', animationDuration, defaultValue: PinputConstants._animationDuration));
    ...
    properties.add(DiagnosticsProperty<TextInputType>('keyboardType', keyboardType, defaultValue: TextInputType.number));
    properties.add(DiagnosticsProperty<ToolbarOptions>('toolbarOptions', toolbarOptions, defaultValue: const ToolbarOptions(paste: true)));
    ...
    properties.add(DiagnosticsProperty<PinputAutovalidateMode>('pinputAutovalidateMode', pinputAutovalidateMode, defaultValue: PinputAutovalidateMode.onSubmit));
    properties.add(DiagnosticsProperty<HapticFeedbackType>('hapticFeedbackType', hapticFeedbackType, defaultValue: HapticFeedbackType.disabled));
    properties.add(DiagnosticsProperty<String?>('senderPhoneNumber', senderPhoneNumber, defaultValue: null));
